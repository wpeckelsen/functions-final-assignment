...
const gradesB = [9, 8, 5, 7, 7, 4, 9, 8, 8, 3, 6, 8, 5, 6, 8, 9, 10, 10, 10];
...
for (let i = 0; i < grades.length; i++) {
    if (grades[i] > 7 ) {
        cumLaudeCounter = cumLaudeCounter+1;
    }
}


console.log("the number of cum Laude students is: " + cumLaudeCounter);
console.log("----------")
...
console.log(cumLaude(grades), "const gradesa")
console.log(cumLaude(gradesB), "const gradesb")
...
if (averageGrade === 6.642857142857143) {console.log(averageGrade, "this is correct!!")}
...
function averageGradeFunction (grades) {
    let sumOfGrades = 0;

    for (let i = 0; i < grades.length; i++) {
        sumOfGrades = sumOfGrades + grades[i] }

    console.log("this function calculates: " + sumOfGrades/grades.length);

}


averageGradeFunction(gradesB)
